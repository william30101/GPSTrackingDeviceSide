...
/**
 * Created by williamwu on 13/09/2017.
 */
...
public class GPSTracker extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAltitudeTextView = (TextView) findViewById(R.id.altitud_text);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(GPSTracker.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(GPSTracker.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
            ...
            showSnackbar(R.string.permission_rationale,
                    android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(GPSTracker.this,
